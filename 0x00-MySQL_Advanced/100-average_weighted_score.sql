-- SQL script that creates a stored procedure ComputeAverageWeightedScoreForUser and
...
BEGIN
    ...
    -- Calculate the weighted sum scores
    ...
    -- Update the user's average table score
